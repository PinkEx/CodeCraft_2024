...
plt.plot(ids, scores3, color="tab:green", label='ver. cur')

plt.axhline(y=average1, color='blue', linestyle='--', label='Average 1')
plt.axhline(y=average2, color='orange', linestyle='--', label='Average 2')
plt.axhline(y=average3, color='green', linestyle='--', label='Average 3')
